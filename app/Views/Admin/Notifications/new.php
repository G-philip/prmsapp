...
<?= $this->section("title") ?> New | Notification <?= $this->endSection() ?>
...
<div class="report-container">
  <div class="report-controls">
    <div class="controls-left">
        <p class="text-info" style="margin: 10px;"><i class="fas fa-plus fa-fw"></i> New Notification Message </p>
    </div>
</div>
...
<?php if (session()->has('errors')): ?>
    ...
    <div class="report-body">
      ...
      <?php echo form_open('/admin/notifications/create', 'class="formm" id="formm"'); ?>

                  <?= $this->include('Admin/Notifications/form'); ?>

                    <div  class="my-3">
                      <a class="btn btn-link" href="<?= site_url("/admin/notifications")?>">&laquo;cancel</a>
