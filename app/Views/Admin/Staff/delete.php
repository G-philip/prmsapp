...
<?= $this->section("title") ?> Delete Staff <?= $this->endSection() ?>
  ...
  <div class="report-content">
    <div class="report-body">
			...
			<div class="text-centerr" style="margin-top: 30px;">
				<p>Are you sure you want to delete staff<strong>&nbsp;<?= $staff->name ?>&nbsp;<i class="fa fa-question text-dangerr"></i></strong></p>
				<?= form_open("/admin/staff/delete/{$staff->staff_id}")?>
				<button class="btn btn-danger btn-sm">Yes</button>&nbsp;&nbsp;
				<a href="<?= site_url('/admin/staff/')?>">Cancel</a>
				</form>
