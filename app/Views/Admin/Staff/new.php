...
<?= $this->section("title") ?> New Staff <?= $this->endSection() ?>
...
<div class="report-container">
  <div class="report-controls">
    <div class="controls-left">
        <p class="text-info" style="margin: 10px;"><i class="fas fa-plus fa-fw"></i> New Staff</p>
    </div>
</div>
...
<?php if (session()->has('errors')): ?>
    ...
    <div class="report-body">
      ...
      <?php echo form_open('/admin/staff/create', 'class="form" id="form"'); ?>
