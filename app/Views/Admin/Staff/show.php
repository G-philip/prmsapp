...
<div class="main">
    ...
    <div class="report-container">
      <div class="report-controls">
        <div class="controls-left">
            <p class="text-info" style="margin: 7px;">Staff: <?= esc($staff->name) ?></p>
          </div>
          <!-- Add new button -->
          <button class="report-button text-info">
            <i class="fas fa-pluss fa-fw"></i><a class="report-button" href="<?= site_url("/admin/staff")?>" style="text-decoration: none;">&laquo; Back to index</a>
          </button>
        </div>
  </div>
  ...
  <div class="report-header">
    ...
    <h5 class="report-name  text-info font-weight-bold">HOSPITAL STAFF DETAILS
            ...
            <div  id="findings" class="col-xl-8 col-lg-4">
              ...
              <!-- <div class="card shadow mb-4">
                ...
                <table class="table table-bordered" id="dataTable" cellspacing="0">
                  ...
                  <tbody>
                    <tr>
                    <td class='text-centerr font-weight-bold text-secondary'><?php //esc($user->email) ?></td>
                      <td class='text-centerr font-weight-bold text-secondary'><?php //esc($user->is_admin) ?></td>
                      <td class='text-centerr font-weight-bold text-secondary'><?php //esc($user->is_doctor) ?></td>
                ...
                <table class="table table-bordered" id="dataTable" cellspacing="0">
                  ...
                  <tbody>
                    <tr>
                    <td class='text-centerr font-weight-bold text-secondary'><?php //esc($staff->agreed_salary) ?></td>
