...
<div class="main">
    ...
    <div class="report-container">
      <div class="report-controls">
        <div class="controls-left">
          ...
          <!-- Add new button -->
          <button class="report-button">
            <i class="fas fa-plus fa-fw"></i><a class="report-button" href="<?= site_url("admin/invoice/new") ?>" style="text-decoration: none;"> Add New</a>
          </button>
        </div>
  ...
  <div class="report-header">
    ...
    <h5 class="report-name  text-info">Hospital Invoice Details
  ...
  <tbody>
    <tr class="successs">
      ...
      <td class="text-center font-weight-boldd">
        ...
        <a href="#delete-prescription" class="text-xs font-weight-bbold text-danger text-uppercase mb-1 delete-prescription"
             data-toggle="modal" value="<?= esc($prescription->id) ?>">Delete</a>
      </td>
    </tr>
