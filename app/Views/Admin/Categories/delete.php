...
<div class="modal modal-alert fade" id="deleteCategory" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content rounded-4 shadow">
      <div class="modal-body p-4 text-center">
        <!-- <h5 class="mb-0"><i class="fa fa-trash " style="font-size:1.5rem"></i>&nbsp;Delete Confirmation!!</h5> -->
        <?= form_open("/admin/expense/category/delete") ?>
        <input type="text" id="category_id" class="delete_id" name="category_id" hidden>
        <p class="mb-0">Are you sure you want to delete&nbsp;<q id="delete_name"></q>&nbsp; permanently&nbsp;<i class="fa fa-question-circle"></i></p>
