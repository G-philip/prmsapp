...
<div class="login-container">
    ...
    <?= form_open("/password/processreset/$token") ?>
      ...
      <div class="form-container" style="margin-top: 20px; padding: 10px;">
              ...
              <div class="field">
                <label for="password_confirmation" class="label text-secondary">Repeat Password</label>
                <p class="control has-icons-left">
                  <input class="input" type="password" placeholder="confirm password" name="password_confirmation" id="password_confirmation">
                  <span class="icon is-small is-left">
                    <i class="fas fa-lock"></i>
                  </span>
                </p>
